  ...
  return (
    <Navbar className="mx-auto w-full max-w-screen-2xl bg-blue-100">
      <div className="flex items-center md">
        ...
        >
          <Image src={logo} alt='logo' className=' h-14' objectPosition=''></Image>
        </Typography>
